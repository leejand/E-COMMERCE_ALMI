export default function WhatsAppButton() {
  return (
    <a
      className="fixed bottom-24 right-6 md:bottom-10 md:right-10 z-[60] w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 active:scale-90 transition-transform duration-300 group"
      href="https://wa.me/#"
      target="_blank"
    ...
    >
      ...
      <span className="absolute right-16 bg-white text-on-surface px-3 py-1 text-xs font-label-bold shadow-sm opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
        Chat with us
      </span>
    </a>
  )
