export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-[72px] md:bottom-8 right-4 md:right-8 z-50 w-10 h-10 md:w-12 md:h-12 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-lg hover:scale-105 active:scale-95 transition-all duration-300 group"
    >
